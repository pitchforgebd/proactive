...
export const generateMetadata = buildPageMetadata('leadership-message', {
...
export default async function LeadershipMessagePage() {
  const page = await getPage('leadership-message');
  if (!page) notFound();

  return <SectionRenderer sections={page.sections} pageSlug="leadership-message" />;
}
